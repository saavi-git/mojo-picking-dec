...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
    ({ className, ...props }, ref) => (
        <div
            className={cn("rounded-md bg-[#FFFFFF] text-card-foreground shadow-sm", className)}
            {...props}
            ref={ref}
        />
    )
...
const CardContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
    ({ className, ...props }, ref) => (
        <div className={clsx("p-6 pt-0", className || "")} {...props} ref={ref} />
    )
);
...
export { Card, CardHeader, CardTitle, CardDescription, CardContent, CardFooter, CardBody }
